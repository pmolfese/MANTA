...
struct ReceiverPhotogrammetrySampleSequence: Sequence {
    let descriptors: [ReceiverReconstructionSampleDescriptor]
    ...
    static func loadDepthBuffer(
        _ descriptor: ReceiverReconstructionSampleDescriptor
    ) -> CVPixelBuffer? {
